package com.efeiyi.demo.utils;

import android.os.Environment;
import android.support.annotation.IntDef;
import android.util.Log;

import com.efeiyi.demo.MyApplication;
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.appContext.getExternalCacheDir() != null)
                dir = MyApplication.appContext.getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MyApplication.appContext.getCacheDir() + File.separator + "log" + File.separator;
            }
        }
